...
export default {
  setup() {
    ...
    onMounted(()=>{
      axios.get(' http://127.0.0.1:8000/api/historys/${route.params.id}/edit')
      .then (response => {
        console.log(response.data.data.nama)

        history.keterangan = response.data.data.keterangan
          history.deskripsi = response.data.data.deskripsi
